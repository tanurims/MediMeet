      ...
      <div className='flex-items-center gap-4'>
        ...
        ? <div 
          ...
          >
            ...
            />
            <div className={`absolute top-0right-0 mt-2 text-base font-medium text-gray-600 z-50 transition-all duration-200 ${showDropdown ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
